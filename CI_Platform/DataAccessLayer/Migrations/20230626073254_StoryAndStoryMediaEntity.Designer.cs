...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230626073254_StoryAndStoryMediaEntity")]
    partial class StoryAndStoryMediaEntity
    {
            ...
            modelBuilder.Entity("Entities.DataModels.Banner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1L,
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 6, 26, 13, 2, 54, 32, DateTimeKind.Unspecified).AddTicks(4154), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 6, 26, 13, 2, 54, 32, DateTimeKind.Unspecified).AddTicks(4155), new TimeSpan(0, 5, 30, 0, 0)),
                            SortOrder = 1,
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Entities.DataModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "admin",
                            LastName = "admin",
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 6, 26, 13, 2, 54, 32, DateTimeKind.Unspecified).AddTicks(4009), new TimeSpan(0, 5, 30, 0, 0)),
