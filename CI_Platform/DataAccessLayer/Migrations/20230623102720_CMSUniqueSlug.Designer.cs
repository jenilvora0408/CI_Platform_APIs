...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230623102720_CMSUniqueSlug")]
    partial class CMSUniqueSlug
    {
            ...
            modelBuilder.Entity("Entities.DataModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 6, 23, 15, 57, 20, 86, DateTimeKind.Unspecified).AddTicks(3215), new TimeSpan(0, 5, 30, 0, 0)),
                            Email = "noreply.ci.tatvasoft@gmail.com",
                            FirstName = "admin",
                            LastName = "admin",
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 6, 23, 15, 57, 20, 86, DateTimeKind.Unspecified).AddTicks(3232), new TimeSpan(0, 5, 30, 0, 0)),
