...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230703053305_FavMissionAndMissionRating")]
    partial class FavMissionAndMissionRating
    {
            ...
            modelBuilder.Entity("Entities.DataModels.Banner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1L,
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 7, 3, 11, 3, 4, 616, DateTimeKind.Unspecified).AddTicks(332), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 7, 3, 11, 3, 4, 616, DateTimeKind.Unspecified).AddTicks(350), new TimeSpan(0, 5, 30, 0, 0)),
                            SortOrder = 1,
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Entities.DataModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 7, 3, 11, 3, 4, 616, DateTimeKind.Unspecified).AddTicks(102), new TimeSpan(0, 5, 30, 0, 0)),
                            Email = "noreply.ci.tatvasoft@gmail.com",
                            FirstName = "admin",
                            LastName = "admin",
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 7, 3, 11, 3, 4, 616, DateTimeKind.Unspecified).AddTicks(121), new TimeSpan(0, 5, 30, 0, 0)),
