...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230630044419_removeSortOrderIndexFromBanner")]
    partial class removeSortOrderIndexFromBanner
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.DataModels.Banner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1L,
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 6, 28, 14, 2, 22, 164, DateTimeKind.Unspecified).AddTicks(2644), new TimeSpan(0, 5, 30, 0, 0)),
                            ...
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTimeOffset(new DateTime(2023, 6, 28, 14, 2, 22, 164, DateTimeKind.Unspecified).AddTicks(2644), new TimeSpan(0, 5, 30, 0, 0)),
                            SortOrder = 1,
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Entities.DataModels.FavouriteMission", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("FavouritesByUserId")
                        .HasColumnType("bigint")
                        .HasColumnName("favourites_by_user_id");
                    ...
                    b.HasIndex("FavouritesByUserId");

                    b.HasIndex("MissionId");

                    b.ToTable("favourite_missions", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.DataModels.MissionApplication", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("mission_applications", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.DataModels.MissionRating", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("RatingGivenByUserId")
                        .HasColumnType("bigint")
                        .HasColumnName("rating_given_by_user_id");
                    ...
                    b.ToTable("mission_ratings", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.DataModels.Story", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Entities.DataModels.StoryMedia", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Entities.DataModels.User", b =>
                {
                    ...
                    b.Property<string>("Avatar")
                        ...
                        .HasDefaultValueSql("'/assets/avatar/profile.png'");
            ...
            modelBuilder.Entity("Entities.DataModels.FavouriteMission", b =>
                {
                    b.HasOne("Entities.DataModels.User", "User")
                        .WithMany()
                        .HasForeignKey("FavouritesByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.DataModels.MissionApplication", b =>
                {
                    ...
                    b.HasOne("Entities.DataModels.Volunteer", "Volunteer")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.DataModels.MissionRating", b =>
                {
                    b.HasOne("Entities.DataModels.Mission", "Mission")
                        .WithOne("MissionRating")
                        .HasForeignKey("Entities.DataModels.MissionRating", "MissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.DataModels.StoryMedia", b =>
                {
                    b.HasOne("Entities.DataModels.Story", "Story")
                        .WithMany("Medias")
